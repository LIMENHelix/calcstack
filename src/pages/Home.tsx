      ...
      <section className="mb-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {CALCULATORS.filter((c) =>
            ['motor-circuit-calculator', 'ampacity-derating-calculator', 'box-fill-calculator', 'conduit-fill-calculator', 'pool-chemical-calculator', 'pool-volume-calculator'].includes(c.slug),
          ).map((c) => (
