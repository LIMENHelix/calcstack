      ...
      <section className="mb-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {CALCULATORS.filter((c) =>
            ['superheat-subcooling-calculator', 'room-airflow-calculator', 'duct-size-calculator', 'service-load-calculator', 'motor-circuit-calculator', 'ampacity-derating-calculator'].includes(c.slug),
          ).map((c) => (
