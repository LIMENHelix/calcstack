      ...
      <section className="mb-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {CALCULATORS.filter((c) =>
            ['ampacity-derating-calculator', 'box-fill-calculator', 'conduit-fill-calculator', 'pool-chemical-calculator', 'pool-volume-calculator', 'pool-heater-calculator'].includes(c.slug),
          ).map((c) => (
